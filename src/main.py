# main.py
#
# Copyright 2025 Aryan Karamtoth <aryankmmiv@outlook.com>
#
...
class GarnishApplication(Adw.Application):
    ...
    def __init__(self):
        super().__init__(application_id='com.spaciouscoder78.garnish',
                         flags=Gio.ApplicationFlags.DEFAULT_FLAGS,
                         resource_base_path='/com/spaciouscoder78/garnish')
